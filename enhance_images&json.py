...
if __name__ == "__main__":
    file_dir = "/Volumes/My_Passport/LBT/DATASET/anti-vibration_hammer/detesets/1/val/"
    save_dir = "/Volumes/My_Passport/LBT/DATASET/anti-vibration_hammer/detesets/1/v/"
